Authors: Brett Dale, Katherine Blanton
Version: 12/11/2021
...
Instructions: In order to run this program, first you must have all the files needed to be located in their appropriate
              package/folder. There are three folders: client, common, and server, that each have files in each. Please look at
              the files needed to make sure each file is in their appropriate package/folder. All of these folders must be
              stored in the same folder as well. Once this is done, you must be outside the three folders, but in the folder
              containing the 3 folders, and you will type to compile instruction located above. Once this compiles, you MUST run
              ...
              you type the client usage. You may NOT have the same usernames for your players. After all the players have
...
Bugs/Errors Known: A client surrendering does kill the connection to the server and the server acknowledges that the client
                   will not continue sending messages. However, the client hangs even after the connection with the server has
                   been terminated.

-----------------------------------------------------------------------------------------------------------------------------------
Contributions: Katherine and Brett met up and worked on each feature of the program together. We wrote all of the project
               together.